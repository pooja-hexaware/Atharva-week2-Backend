...
__decorate([
    (0, common_1.Post)(),
    openapi.ApiResponse({ status: 201, type: require("../schemas/menus.schema").menus }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [menus_dto_dto_1.menusDto]),
    __metadata("design:returntype", Promise)
], menusController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    openapi.ApiResponse({ status: 200, type: [require("../schemas/menus.schema").menus] }),
    __metadata("design:type", Function),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], menusController.prototype, "findMenuToppings", null);
__decorate([
    (0, common_1.Post)('/:id'),
    openapi.ApiResponse({ status: 201, type: require("../schemas/menus.schema").menus }),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, menus_dto_dto_1.menusDto]),
